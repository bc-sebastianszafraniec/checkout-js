...
### [1.446.3-prerelease.1709196114200](https://github.com/bigcommerce/checkout-js/compare/v1.320.1...v1.446.3-prerelease.1709196114200) (2024-02-29)
...
* **payment:** PI-1625 [Affirm][CheckoutJS] Refactor the existing `Affirm` components in Checkout JS to use the new checkout payment integration JS API ([e32bcf6](https://github.com/bigcommerce/checkout-js/commit/e32bcf6a912c7cc20e1a57388053cc99183243cd))
* **payment:** PI-1625 [Affirm][CheckoutJS] Refactor the existing `Affirm` components in Checkout JS to use the new checkout payment integration JS API ([080da49](https://github.com/bigcommerce/checkout-js/commit/080da497859fe14e94859fe32d5f5961b0ade83e))
