...
### [1.528.1-prerelease.1727962890975](https://github.com/bigcommerce/checkout-js/compare/v1.464.2...v1.528.1-prerelease.1727962890975) (2024-10-03)
...
* **payment:** PI-1595 Refactor the existing `AmazonPay` and `AmazonPayV2` components in Checkout JS to use the new checkout payment integration JS API ([3caaed3](https://github.com/bigcommerce/checkout-js/commit/3caaed395aa8838dd8dba0fb7886559a4a1cf717))
* **payment:** PI-1595 Refactor the existing `AmazonPay` and `AmazonPayV2` components in Checkout JS to use the new checkout payment integration JS API ([61382ce](https://github.com/bigcommerce/checkout-js/commit/61382ce2d141b75884b36e8b91aebb6f9a46fc40))
* **payment:** PI-1595 Refactor the existing `AmazonPay` and `AmazonPayV2` components in Checkout JS to use the new checkout payment integration JS API ([13f4667](https://github.com/bigcommerce/checkout-js/commit/13f4667b11d7443d3a3b508fd76163b11b9ca31d))
