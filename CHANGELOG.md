...
### [1.333.3-prerelease.1689077118641](https://github.com/bigcommerce/checkout-js/compare/v1.320.1...v1.333.3-prerelease.1689077118641) (2023-07-11)
...
* **payment:** PI-175 [Stripe] Guest Customers able to checkout without agreeing to Privacy Policy when using Stripe Link ([67cb8be](https://github.com/bigcommerce/checkout-js/commit/67cb8be909c3670511fd60aa8fd663c207caa2df))
* **payment:** PI-175 [Stripe] Guest Customers able to checkout without agreeing to Privacy Policy when using Stripe Link ([f4b8606](https://github.com/bigcommerce/checkout-js/commit/f4b86069441e733ad696549d0c2badb5ee157815))
* **payment:** PI-175 [Stripe] Guest Customers able to checkout without agreeing to Privacy Policy when using Stripe Link ([2f638c9](https://github.com/bigcommerce/checkout-js/commit/2f638c9b45d7dc40fa5bc7114f7a16117579f8e4))
