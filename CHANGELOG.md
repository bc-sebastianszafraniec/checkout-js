...
### [1.542.1-prerelease.1730797360853](https://github.com/bigcommerce/checkout-js/compare/v1.542.1-prerelease.1730797171092...v1.542.1-prerelease.1730797360853) (2024-11-05)

### [1.542.1-prerelease.1730797171092](https://github.com/bigcommerce/checkout-js/compare/v1.464.2...v1.542.1-prerelease.1730797171092) (2024-11-05)
...
* **payment:** PI-1564 Refactor the existing `Moneris` components in Checkout JS to use the new checkout payment integration JS API ([d6ccde8](https://github.com/bigcommerce/checkout-js/commit/d6ccde87d1c859e04ee86bda4f72f4f19137c300))
* **payment:** PI-1564 Refactor the existing Moneris components in Checkout JS to use the new checkout payment integration JS API ([5134258](https://github.com/bigcommerce/checkout-js/commit/513425870942f20294e7f61d62079ecff57a918e))
* **payment:** PI-1564 Refactor the existing Moneris components in Checkout JS to use the new checkout payment integration JS API ([e1aa63e](https://github.com/bigcommerce/checkout-js/commit/e1aa63e00f9ee2cfc86799afc38aaba38595251a))
