...
### [1.379.4-prerelease.1699450534251](https://github.com/bigcommerce/checkout-js/compare/v1.320.1...v1.379.4-prerelease.1699450534251) (2023-11-08)
...
* **payment:** PI-875 [Stripe] Error while try to save Stripe Link stored card as BC vaulted instrument ([f1f2ac3](https://github.com/bigcommerce/checkout-js/commit/f1f2ac3823849feba009609f864909f39a313c0b))
* **payment:** PI-875 [Stripe] Error while try to save Stripe Link stored card as BC vaulted instrument ([042a5ce](https://github.com/bigcommerce/checkout-js/commit/042a5ce1406d584b877431aad1927a67d92c9d10))
* **payment:** PI-875 [Stripe] Error while try to save Stripe Link stored card as BC vaulted instrument ([78770b7](https://github.com/bigcommerce/checkout-js/commit/78770b714139f7ed7cdae09d8a2e1b65a406d5be))
* **payment:** PI-875 [Stripe] Error while try to save Stripe Link stored card as BC vaulted instrument ([7cc581b](https://github.com/bigcommerce/checkout-js/commit/7cc581b3f73af6b5859b246924a9e9b4f2434c34))
* **payment:** PI-875 [Stripe] Error while try to save Stripe Link stored card as BC vaulted instrument ([e3ed4f5](https://github.com/bigcommerce/checkout-js/commit/e3ed4f5d96c2cc7916128a5c6633ab562edd236b))
* **payment:** PI-875 [Stripe] Error while try to save Stripe Link stored card as BC vaulted instrument ([9d83ab3](https://github.com/bigcommerce/checkout-js/commit/9d83ab334f48b497bd576aa86476de105c76b559))
* **payment:** PI-875 [Stripe] Error while try to save Stripe Link stored card as BC vaulted instrument ([d312372](https://github.com/bigcommerce/checkout-js/commit/d31237287f2787fd2133d42d9f971f187d985074))
