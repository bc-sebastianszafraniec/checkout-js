...
### [1.458.1-prerelease.1711013381936](https://github.com/bigcommerce/checkout-js/compare/v1.458.1-prerelease.1711013238575...v1.458.1-prerelease.1711013381936) (2024-03-21)

### [1.458.1-prerelease.1711013238575](https://github.com/bigcommerce/checkout-js/compare/v1.320.1...v1.458.1-prerelease.1711013238575) (2024-03-21)
...
* **payment:** PI-1723 [KlarnaV2] Refactor the existing `KlarnaV2` components in Checkout JS to use the new checkout payment integration JS API ([b646104](https://github.com/bigcommerce/checkout-js/commit/b646104f1de5c9ce9ba1377e51c6b6e73d71fff9))
* **payment:** PI-1723 [KlarnaV2] Refactor the existing `KlarnaV2` components in Checkout JS to use the new checkout payment integration JS API ([5f262ff](https://github.com/bigcommerce/checkout-js/commit/5f262ffbdabfcef02ebd46eeb7fcd710c941a8d3))
* **payment:** PI-1723 [KlarnaV2] Refactor the existing `KlarnaV2` components in Checkout JS to use the new checkout payment integration JS API ([884e9a0](https://github.com/bigcommerce/checkout-js/commit/884e9a000d37d98691e3625c166071d4a8e751b0))
