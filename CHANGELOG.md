...
### [1.458.1-prerelease.1711365247518](https://github.com/bigcommerce/checkout-js/compare/v1.320.1...v1.458.1-prerelease.1711365247518) (2024-03-25)
...
* **payment:** PI-1723 [KlarnaV2] Refactor the existing `KlarnaV2` components in Checkout JS to use the new checkout payment integration JS API ([5b98451](https://github.com/bigcommerce/checkout-js/commit/5b984516e19e65044100c4a79fa3250012809dc7))
* **payment:** PI-1723 [KlarnaV2] Refactor the existing `KlarnaV2` components in Checkout JS to use the new checkout payment integration JS API ([99d0a49](https://github.com/bigcommerce/checkout-js/commit/99d0a49162d869dd921accbcc23e8a5aa3917046))
...
* **payment:** PI-1793 [Klarna] Refactor the existing `Klarna` components in Checkout JS to use the new checkout payment integration JS API ([776b135](https://github.com/bigcommerce/checkout-js/commit/776b1355fca018d7afdd263ed3ac1da1fc1482ba))
