...
### [1.458.1-prerelease.1711008999569](https://github.com/bigcommerce/checkout-js/compare/v1.320.1...v1.458.1-prerelease.1711008999569) (2024-03-21)
...
* **payment:** PI-1723 [KlarnaV2] Refactor the existing `KlarnaV2` components in Checkout JS to use the new checkout payment integration JS API ([b796e58](https://github.com/bigcommerce/checkout-js/commit/b796e585133e238fda783463e4d556c8bf527d92))
* **payment:** PI-1723 [KlarnaV2] Refactor the existing `KlarnaV2` components in Checkout JS to use the new checkout payment integration JS API ([1a0f522](https://github.com/bigcommerce/checkout-js/commit/1a0f52279ec15b89e42912c6cddb59234a73d3b5))
...
* **payment:** PI-1793 [Klarna] Refactor the existing `Klarna` components in Checkout JS to use the new checkout payment integration JS API ([ff58eca](https://github.com/bigcommerce/checkout-js/commit/ff58eca0286dd7e65e5d52c8266b092b61c50ff7))
